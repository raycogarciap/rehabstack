...
// Layout público para /pricing.
// Incluye navbar ligera con logo + navegación y un footer simple.
...
export const metadata: Metadata = {
  ...
  description:
    "Simple, transparent pricing for AI agents built for physical therapy and rehabilitation professionals.",
};
    ...
    <header className="sticky top-0 z-50 border-b border-neutral-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <nav className="hidden items-center gap-6 text-sm font-medium text-neutral-600 sm:flex">
          <Link href="/agents"  className="hover:text-neutral-900 transition-colors">Agents</Link>
