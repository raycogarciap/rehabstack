...
// Verifica autenticación (doble comprobación junto al middleware).
...
// Componente async interno que carga datos del usuario y renderiza el sidebar.
// Separado para que Suspense muestre el skeleton mientras se resuelve Supabase.
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-neutral-50">
      {/* Sidebar con Suspense: muestra skeleton mientras carga datos del usuario */}
      <Suspense fallback={<SidebarSkeleton />}>
        <DashboardNav />
      </Suspense>

      {/* Contenido principal
          - pt-14: compensa barra superior fija en móvil
          - md:pl-60: compensa sidebar fijo en escritorio */}
