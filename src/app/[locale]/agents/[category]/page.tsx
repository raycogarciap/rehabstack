// Página de categoría del marketplace — /[locale]/agents/[category] — Server Component.
// Muestra el título y descripción de la categoría seguidos del grid de agentes.
...
export default async function CategoryPage({ params }: Props) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      ...
      {/* Grid de agentes o estado vacío */}
      {agents.length === 0 ? (
